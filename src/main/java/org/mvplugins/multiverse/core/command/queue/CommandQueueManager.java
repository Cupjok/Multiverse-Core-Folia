...
import org.mvplugins.multiverse.core.utils.scheduler.MVTask;
...
public class CommandQueueManager {
     ...
     * @return The expire {@link MVTask}.
     */
    @NotNull
    private MVTask runExpireLater(@NotNull String senderName, int validDuration) {
    ...
    public void removeFromQueue(@NotNull String senderName) {
        ...
        Option.of(payload.expireTask()).peek(MVTask::cancel);
